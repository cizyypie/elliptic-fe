        ...
        <div className="space-y-4">
          ...
          {/* <div className="flex gap-2">
            <input
              ...
              disabled={verifying}
              className="flex-1 border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none disabled:bg-gray-100"
            />
            <button
